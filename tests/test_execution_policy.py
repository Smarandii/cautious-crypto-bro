...
def test_exit_policy_defaults() -> None:
    ...
    assert policy.exit_policy.basic_r_multiple == Decimal("0.5")
    assert policy.exit_policy.medium_r_multiple == Decimal("1")
    assert policy.exit_policy.high_r_multiple == Decimal("2")
